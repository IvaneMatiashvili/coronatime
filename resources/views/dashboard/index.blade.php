<x-dashboard-layout title="{{ __('content.worldwide-statistic') }}" content="worldwide" username="{{ $user->name }}">
    ...
    <div class="sm:h-[15.938rem] h-[32rem] sm:ml-[9.25rem] flex sm:flex-row flex-col justify-start font-inter items-center mt-[2.5rem]">
        <div class="sm:w-[31rem] w-[23rem] h-[15.938rem] flex flex-col items-center justify-center bg-blue-bg bg-cover bg-center bg-fixed rounded-3xl bg-no-repeat ">
            <x-svg.new-cases-svg/>
        ...
        <x-flex.row class="justify-between w-[23rem] sm:w-[67rem] sm:mt-0 mt-8 sm:ml-[5rem] ml-0">
            <x-flex.col class="sm:w-[31rem] break-all w-[11rem] h-[15.938rem] bg-green-bg bg-cover rounded-3xl bg-center bg-fixed  bg-no-repeat">
                <x-svg.recovered-svg/>
            ...
            <x-flex.col class="sm:w-[31rem] break-all w-[11rem] h-[15.938rem] bg-yellow-bg bg-cover sm:ml-[5rem] rounded-3xl bg-center bg-fixed  bg-no-repeat">
                <x-svg.death-svg/>
