<x-email-layout>
    ...
    <div class="content-container">
        ...
        margin-top: 3.5rem;
        color: #010414;
        font-family: 'Inter', 'sans-serif';">{{ __('content.recover-password') }}</p>
        ...
        color: #010414;
        width: 100%;
        font-family: 'Inter', 'sans-serif';">{{ __('content.click-btn-recover') }}</p>
        <a href="{{ route('reset.password.get', $user->token) }}" style=" font-weight: 900;
        font-size: 1rem;
        color: #FFFFFF;
        background: #0FBA68;
        display: block;
